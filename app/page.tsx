...
>
  ...
  <div className="bg-white p-6 rounded-[3rem] shadow-xl text-center max-w-[300px]">
    ...
    <img 
      ...
      className="w-36 h-36 rounded-full object-cover object-[center_30%] border-4 border-blue-600 mx-auto"
    />
  ...
  <div className="bg-white p-6 rounded-[3rem] shadow-xl text-center max-w-[300px]">
    ...
    <img 
      ...
      className="w-36 h-36 rounded-full object-cover object-[center_75%] border-4 border-blue-600 mx-auto"
    />
